...
public class FolderDAO extends BaseDAO<Folder> {
	...
	public ArrayList<Folder> findRootFoldersUntilSequence(Project project, long sequence) {
	...
	public ArrayList<Folder> findSubFoldersUntilSequence(final long id, final long sequence) throws DatabaseException {
		final String query = "select f from folder f where f.parentFolder.id = :parentId and f.entry.revision < :revision";
		final Object[] parameter1 = new Object[]{"parentId", id};
		final Object[] parameter2 = new Object[]{"revision", sequence};
