...
//		
	...
	public ArrayList<ObjFile> getFilesFromFolderUntilSequence(long id, long sequence) {
	...
	public List<String> getFilesPathFromSequenceNumber(final Project project, final long sequenceNumber) throws DatabaseException {
		final String query = "select DISTINCT f.path from file f where f.entry.project = :project and f.entry.sequenceNumber = :sequenceNumber";
		final Object[] parameter1 = new Object[]{"project", project};
		final Object[] parameter2 = new Object[]{"sequenceNumber", sequenceNumber};
